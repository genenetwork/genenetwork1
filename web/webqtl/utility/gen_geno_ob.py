        ...
        for line in lines:
            if line[0] == "#":
                ...
                if len(self.parlist) > 0:
                    self.prgy = self.parlist + self.prgy
    ...
    def __init__(self, geno_ob, marker_row = None):
        ...
        if marker_row:
            ...
            try:
                ...
                self.cM = 0
                if geno_ob.Mbmap:
                    self.cM = float(marker_row[geno_ob.mb_column])
            try:
                self.Mb = None
                if geno_ob.Mbmap:
                    self.Mb = float(marker_row[geno_ob.mb_column])
            except:
                self.Mb = self.cM
